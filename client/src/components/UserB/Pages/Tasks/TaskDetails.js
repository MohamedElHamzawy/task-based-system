          ...
          {task.freelancer && (
            <>
              ...
              <div className="col-12 col-md-6 row ">
                ...
                <p className="d-inline col-12 col-sm-6 p-2 edit-form-p details-data fw-bold text-danger data">
                  {" "}
                  {task.cost}{" "}
                </p>
              </div>
            ...
            {!comments.length == 0 ? (
              comments.map((comment) => (
                <div className="comment text-start row  my-1" key={comment._id}>
                  <h6 className="col-12 col-sm-4 edit-form-lable fw-bold pt-2">
                    {comment.user_id && comment.user_id.fullname} :{" "}
                  </h6>
                  <p className="col-10 col-sm-7 fw-bold text-sm-start text-center pt-2">
                    {comment.content}{" "}
                  </p>
