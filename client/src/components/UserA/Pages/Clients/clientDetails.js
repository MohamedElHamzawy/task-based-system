        ...
        <div className="text-center row w-100 p-4 m-0">
            ...
            <div className="row bg-white adduser-form p-1 m-1 justify-content-start">
                ...
                <div className="col-12 col-xl-6 row ">
                    ...
                    <p className={!edit ? "d-inline col-10 col-md-4 py-3 edit-form-p fw-bold " : 'd-none'}> {client.clientname} </p>
                ...
                <div className="col-12 col-xl-6 row p-2 ">
                    ...
                    <p className={!edit ? "d-inline col-10 col-md-4 py-3 edit-form-p fw-bold" : 'd-none'}> {client.email} </p>
                    <div className={edit ? "d-inline col-10 col-md-4 py-3 " : 'd-none'} >
                ...
                <div className="col-12 col-xl-6 row p-2 ">
                    ...
                    <p className={!edit ? "d-inline col-10 col-md-4 py-3 edit-form-p fw-bold" : 'd-none'}> {client.phone} </p>
                    <div className={edit ? "d-inline col-10 col-md-4 py-3 " : 'd-none'} >
                ...
                <div className="col-12 col-xl-6 row p-2 ">
                    ...
                    <p className={!edit ? "d-inline col-10 col-md-4 py-3 edit-form-p fw-bold" : 'd-none'}> {client.country} </p>
                    <div className={edit ? "d-inline col-10 col-md-4 py-3 " : 'd-none'} >
                ...
                <div className="col-12 col-xl-6 row p-2 ">
                    ...
                    <p className={!edit ? "d-inline col-10 col-md-4 py-3 edit-form-p fw-bold" : 'd-none'}> {client.city} </p>
                    <div className={edit ? "d-inline col-10 col-md-4 py-3 " : 'd-none'} >
