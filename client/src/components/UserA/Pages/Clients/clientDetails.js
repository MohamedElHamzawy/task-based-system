  ...
  useEffect(() => {
    ...
    if (loading) {
      ...
      timerId = setTimeout(async () => {
        await axios
          .get(` https://smarteduservices.com:5000/api/client/${id}`)
          .then((res) => {
      ...
      timerId = setTimeout(async () => {
        await axios
          .get(" https://smarteduservices.com:5000/api/currency/")
          .then((res) => {
      ...
      <div className="row bg-white adduser-form p-1 m-1 justify-content-start">
        ...
        <div className="col-12 col-lg-6 row p-2">
          ...
          <p
            className={
              !edit
                ? "d-inline col-12 col-md-6 py-2 edit-form-p details-data "
                : "d-none"
            }
          >
            {" "}
