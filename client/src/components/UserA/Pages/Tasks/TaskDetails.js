    ...
    <div className="text-center row w-100 m-0 justify-content-center">
      ...
      <div className="row mb-4 p-2">
        <div className="col-3 text-center">
          <button className="back-btn p-2 px-3 fs-3 " onClick={() => { window.location.href = '/yourtasks' }}><TiArrowBack /> </button>
        </div>
      ...
      <div className='row col-12 col-lg-8 justify-content-center p-1 mx-1 h-100'>
        <div className="row bg-white adduser-form p-0 m-0 justify-content-start ">
          ...
          <div className="col-12 row p-0 m-0 justify-content-center justify-content-md-start">
            <h5 className="col-md-3 col-12 edit-form-lable text-start pt23 data  fw-bold">Dead Line :</h5>
          ...
          <div className='row w-100 p-0 m-0'>
            {!comments.length == 0 ? comments.map((comment) => (
              ...
              <div className='comment text-start row p-2 pt-3 my-1' key={comment._id}>
                ...
                <p className='col-10 col-sm-7 fw-bold text-sm-start text-center text-dark'>{comment.content} </p>
                {comment.user_id &&
