    ...
    return isLoading ? (
        ...
        <div className="text-center row w-100 p-4 m-0">
            ...
            <div className="row mb-4">
                ...
                <h2 className="col-12 col-lg-7 text-center system-head p-2 pt-4">  Status Details</h2>
            </div>

            <div className="row bg-white adduser-form p-1 m-1 justify-content-center">

                {status.changable ? <div className="col-12 row p-3 justify-content-end ">
                    <div className="col-4">
                ...
                <div className="col-12 col-md-6 row p-3">
                    ...
                    <div className={edit ? "d-inline col-10 col-sm-5 pt-3 " : 'd-none'} >
                        <input type='text' placeholder={status.statusname}
                            ...
                            className={`search w-100 p-2 ${!statusNameState.isvalid &&
                ...
                {status.changable ? < div className="col-12  p-3">
                    {!edit ?
                        <button
