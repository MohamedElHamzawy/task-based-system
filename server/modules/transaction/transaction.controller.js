...
const createTransaction = async (req,res,next) => {
    try {
        const {account_id, accountNumber, method, amount} = req.body;
        const newTransaction = await new transactionModel({transactionType: "paid", task:"000000000000", amount, method, accountNumber, account_id}).save();
